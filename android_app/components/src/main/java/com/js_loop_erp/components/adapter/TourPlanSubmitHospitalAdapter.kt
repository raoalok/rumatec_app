...
class TourPlanSubmitHospitalAdapter (private val listener: TourPlanUpdateDetailsHospitalItemClickListenerI, private var mList1: ArrayList<TripSubmitReportSelectedTourPlanHospital>): RecyclerView.Adapter<TourPlanSubmitHospitalAdapter.ViewHolder>() {

    var onItemClick: ((TourPlanUpdateDetailsHospital) -> Unit)? = null

    private var mList: ArrayList<TripSubmitReportSelectedTourPlanHospital> = mList1 as ArrayList<TripSubmitReportSelectedTourPlanHospital>

    private val checkedList: MutableList<TripSubmitReportSelectedTourPlanHospital> = mutableListOf()
    var selectedPosition = -1

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TourPlanSubmitHospitalAdapter.ViewHolder {
...
//        holder.checkButton.isChecked = ItemsViewModel.isSelected == true
    ...
    fun getCheckedItems(): List<TripSubmitReportSelectedTourPlanHospital> {
        //checkButtin
        //Log.d("TAG", "getCheckedItems1: ${checkedList.size}")
        return mList
    }

    fun getSelected(): TripSubmitReportSelectedTourPlanHospital? {
    ...
    fun filterList(filterList: ArrayList<TripSubmitReportSelectedTourPlanHospital>){
