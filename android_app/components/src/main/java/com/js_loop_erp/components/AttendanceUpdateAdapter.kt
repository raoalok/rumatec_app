...
import com.js_loop_erp.components.fragments.attendance.SubmittedAttendanceItemClickListenerI
...
class AttendanceUpdateAdapter(private val listener: SubmittedAttendanceItemClickListenerI, private val mList1: ArrayList<AttendanceUpdateViewModel>) : RecyclerView.Adapter<AttendanceUpdateAdapter.ViewHolder>(){

    var onItemClick: ((SubmittedInventoryCheckEditFragment) -> Unit)? = null
    // create new views
    private val mList: ArrayList<AttendanceUpdateViewModel> = mList1
