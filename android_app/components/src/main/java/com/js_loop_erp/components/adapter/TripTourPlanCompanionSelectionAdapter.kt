...
import  com.js_loop_erp.components.fragments.tripTourPlan.TripTourPlanCompanionSelectionFragmentItemsOnClickListenerI

class TripTourPlanCompanionSelectionAdapter(private val listener: TripTourPlanCompanionSelectionFragmentItemsOnClickListenerI, private var mList1: ArrayList<TripTourPlanCompanionSelection>): RecyclerView.Adapter<TripTourPlanCompanionSelectionAdapter.ViewHolder>() {

    var onItemClick:((TripTourPlanCompanionSelectionAdapter)-> Unit)? = null
    private var mList: ArrayList<TripTourPlanCompanionSelection> = mList1 as ArrayList<TripTourPlanCompanionSelection>
    private val checkedList: MutableList<TripTourPlanCompanionSelection> = mutableListOf()
    ...
    fun getCheckedItems():List<TripTourPlanCompanionSelection>{
        return mList
    }

    fun filterList(filterList: ArrayList<TripTourPlanCompanionSelection>){
        mList = filterList
    ...
    companion object {
        val TAG: String = TripTourPlanCompanionSelectionAdapter::class.java.name
    }
